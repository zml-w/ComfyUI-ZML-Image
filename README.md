...
# 💕简单介绍一下节点：
**这是一个功能丰富的COMFYUI自定义节点，主要和“图像、文本、整数、LoRA加载器、遮罩”相关，还有一些杂七杂八的小工具。目前节点总数共有60+，一般情况下每隔两天都会有新的节点增加。**

## 尽量保持节点文件夹名称为“ComfyUI-ZML-Image”！！不然可能会导致部分节点无法正常使用，我会在后面几个版本尝试解决这个问题！
