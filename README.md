...
## 💕简单介绍一下节点：
**这是一个功能丰富的COMFYUI自定义节点，目前节点总数共有110+，各个方面的节点都有，已经不再是仅有图像了。**

**节点对环境的要求很低，不会破坏你的comfyui环境**

`我是按照自己的需求来开发的，我经常使用的节点功能会很完善，我自己都不怎么用的节点，可能会有些bug……`
...
> - #### 更新了大概十个节点，还修复了一些bug。
>
> - #### 新分类"XYZ",支持"任意模型"的LoRA的XY图表,支持测试提示词XY图表,支持测试步数和CFG的图表。
>
